...
class EventoRtMapperTest {
    ...
    class CreateEventoTest {
        ...
        void nullDataStartDoesNotThrow() {
            // Difesa contro il caso in cui un futuro path chiami createEvento senza
            // aver settato dataStart: prima del fix la sottrazione dataEnd.toInstant() -
            // dataStart.toInstant() sollevava NPE facendo abortire l'invio dell'evento GDE.
