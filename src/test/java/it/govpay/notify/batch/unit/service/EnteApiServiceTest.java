...
class EnteApiServiceTest {
    ...
    void setUp() {
        ...
        // solo per le lookup su ConnettoreService (getConnettore/getConnettoreAsMap).
        // Non tutti i test arrivano fin li' (alcuni falliscono prima su applicazione
        // mancante), quindi il stubbing e' 'lenient' per evitare UnnecessaryStubbing.
    ...
    void connettoreLookupIsolatedFromOuterTransaction() {
        ...
        // verify fallisce (era 0 in produzione col bug: la chiamata bypassava il template).
