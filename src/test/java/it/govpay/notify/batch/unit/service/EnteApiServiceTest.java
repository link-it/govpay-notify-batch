 ...
 * <p>
 * I test coprono il costruttore, {@code clearCache} e la gestione difensiva
 * dei casi di "configurazione non idonea": in tutti questi casi il metodo
 * NON solleva, il record va in KO nel processor (SERVICE_UNAVAILABLE) e il
 * batch prosegue con le altre righe. Nessun evento GDE viene inviato in
 * questi scenari (non c'e' stata alcuna interazione HTTP con l'ente).
 */
...
class EnteApiServiceTest {
    ...
    void resolveConnectorCodeUsesRepository() {
        ...
        try {
            ...
            // non ci interessa l'esito HTTP in questo test
        }
